...
import individual1 from './images/individual/depositphotos_328182600-stock-photo-depressed-woman-psychotherapy-young-woman.jpg'

import individual2 from './images/individual/depositphotos_255733816-stock-photo-smiling-woman-talking-to-wellness.jpg'
import './terapias.css'
  ...
  <div id="intro">
    ...
    <GeneralLayout>
      ...
      <p className="col-1"></p>
       ...
       <p>Foto de <a href="https://unsplash.com/@quincoetzee?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Quinton Coetzee</a> en <a href="https://unsplash.com/es/fotos/lzlJC_ZY0OI?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
  </p>
      </div>
        </Card>
        </Col>
...
La terapia individual también puede ayudar a las personas a identificar y abordar patrones de pensamiento y comportamiento poco saludables. En la terapia, las personas pueden trabajar con un terapeuta capacitado para identificar patrones de pensamiento y comportamientos negativos que pueden estar contribuyendo a sus problemas de salud mental. Con la ayuda de un terapeuta, las personas pueden aprender nuevos mecanismos y estrategias de afrontamiento para manejar sus pensamientos y emociones de una manera más saludable. A través de la terapia individual, las personas pueden adquirir habilidades para enfrentar los desafíos de la vida y mejorar su salud mental en general.
        ...
        <Card>
        <div class="img-gallery">
        <img  alt='person sitting' className="card-img-top img-fluid " src={individual1}/>
      </div>
        </Card>
      ...
      <div className="col-1"></div>
        ...
        <div class="img-gallery">
        <img  alt='person sitting' className="card-img-top img-fluid " src={individual2}/>
      </div>
        </Card>
        </Col>
        <Col>
